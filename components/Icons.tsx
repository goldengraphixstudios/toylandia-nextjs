...
export function WeightIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="5" r="3" />
      <path d="M6.5 8H3l-1 13h20L21 8h-3.5" />
      <path d="M6.5 8Q6 5 12 5Q18 5 17.5 8" />
    </svg>
  );
}

export function FamilyIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="8" cy="6" r="2.5" />
      <circle cx="16" cy="6" r="2.5" />
      <circle cx="12" cy="15" r="2" />
      <path d="M3 19c0-2.76 2.24-5 5-5h2M16 14h2c2.76 0 5 2.24 5 5" />
      <path d="M10 19c0-1.1.9-2 2-2s2 .9 2 2v2h-4v-2z" />
    </svg>
  );
}
...
export function ToyBrickIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="15.5" cy="6" r="0.5" fill="currentColor" />
    </svg>
  );
}
...
export function StarFilledIcon({ className = base }: IconProps) {
  return (
...
export function BabyIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M5.5 22H18.5a1 1 0 001-1v-1a6 6 0 00-12 0v1a1 1 0 001 1z" />
      <path d="M14.5 4.5c.83-.55 2-.5 2.5.5" />
    </svg>
  );
}

export function ConfettiIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 21l4-10 6 6-10 4z" />
      <path d="M7 11l4-9 2 5-6 4z" />
      <path d="M17 3l1 4-4 1 3-5z" />
      <path d="M20 8l2 2-3 1 1-3z" />
...
export function CakeIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M3 14.803a3 3 0 003 .197 3 3 0 003-.197 3 3 0 013 .197 3 3 0 003-.197 3 3 0 013 .197" />
      <path d="M12 4v5M8 2v2M16 2v2" />
      <circle cx="8" cy="2" r="0.5" fill="currentColor" stroke="none" />
      <circle cx="16" cy="2" r="0.5" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
export function PuzzleIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M19.5 12c0-.23-.01-.45-.03-.68A2 2 0 0022 9.5a2 2 0 00-2-2 2 2 0 00-.75.14V5a2 2 0 00-2-2h-2.36A2 2 0 0013 2a2 2 0 00-2 2 2 2 0 00.36 1.14V7H9a2 2 0 00-2 2v.14A2 2 0 006.5 9a2 2 0 00-2 2 2 2 0 002 2 2 2 0 00.5-.07V15a2 2 0 002 2h2v.14A2 2 0 0013 19a2 2 0 002-2 2 2 0 00-.36-1.14V13h2c.76 0 1.44-.3 1.95-.78.03-.23.03-.46.03-.69" />
    </svg>
  );
}
...
export function ResellersIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
